...
- (IBAction)test:(id)sender
{
	...
	self.stackedNavigationController.tabBarItem.badgeValue = [NSString stringWithFormat:@"%lu", (unsigned long)self.stackedNavigationController.viewControllers.count];
}
